  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: '#0d0020' }}>
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        backgroundImage: 'radial-gradient(circle, rgba(192,132,252,0.12) 1px, transparent 1px)',
...
<div className="pt-1">
            <p className="text-xl sm:text-2xl font-bold tracking-tight" style={{ color: '#FA8112', fontFamily: "'Roboto', sans-serif" }}>Brandior Is The Bridge.</p>
