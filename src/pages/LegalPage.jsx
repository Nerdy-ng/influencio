...
## About Brandior
Brandior is a marketplace platform that connects brands and businesses ("Brands") with content creators, influencers, and creative talent ("Creators"). We facilitate discovery, contracting, and payment between Brands and Creators. Brandior is not a party to any creative services agreement between Brands and Creators — we provide infrastructure and tools to enable those agreements.
...
## Dispute Resolution
(a) Internal Dispute System: Disputes between Brands and Creators must first be raised through Brandior's built-in dispute system within 7 days of delivery or expected delivery. Both parties must submit relevant evidence (screenshots, briefs, delivered files). (b) Brandior's Decision: Brandior will review all submitted evidence and issue a binding decision, including instructions on escrow fund distribution. This decision may be appealed once within 7 days of notification. (c) Escalation: If the matter cannot be resolved through our internal process, it may be referred to arbitration in Lagos, Nigeria, under the Arbitration and Conciliation Act (as amended). The governing law is the law of the Federal Republic of Nigeria. (d) Good Faith: Brandior provides dispute resolution as a good-faith facilitation service and does not guarantee specific outcomes. Our team's decisions on platform matters are final.
...
To the maximum extent permitted by applicable Nigerian law, Brandior and THE OWL COMPANY shall not be liable for: (a) the quality or fitness for purpose of creative deliverables; (b) any indirect, incidental, consequential, or punitive losses; (c) loss of revenue, goodwill, or data; or (d) any harm arising from third-party payment processing failures. Our aggregate liability to any user in respect of any claim shall not exceed the total platform fees paid by that user in the 3 months preceding the claim.
