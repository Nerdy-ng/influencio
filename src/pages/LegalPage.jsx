...
These Terms and Conditions of Use ("Agreement") govern your access to and use of the Brandior platform. By completing registration and clicking "I Agree" or "Create Account", you acknowledge that you have read, understood, and agree to be bound by this Agreement. Your acceptance is recorded electronically with a timestamp and version identifier in Brandior's systems. In addition, by accessing or using any part of the Platform at any time — including browsing the website, downloading the mobile application, logging in, creating a Collab, sending a message, or making any payment — you confirm your continuing acceptance of this Agreement in its current published form. If you do not agree to this Agreement, you must not access or use the Platform in any capacity. Continued use of the Platform following any update to this Agreement constitutes acceptance of the updated terms. This Agreement was last revised in September 2026.
...
9.5 User Content Licence to Brandior. By uploading content to your profile, portfolio, or any part of the Platform, you grant Brandior a non-exclusive, royalty-free, worldwide, perpetual licence to display, reproduce, and use that content for the purpose of operating, promoting, and marketing the Platform, including in advertisements, social media content, pitch decks, marketing materials, and case studies. Brandior will not identify you by name in any external publication without your prior written consent. This licence does not permit Brandior to sell or sublicense your portfolio content to any third party, or to use it to promote any product, service, or brand other than Brandior itself.

9.6 Deliverables Showcase Licence. Upon full release of escrowed funds in respect of a completed Collab, the Creator grants Brandior a non-exclusive, royalty-free, worldwide, perpetual licence to display, reproduce, and use the Deliverables from that Collab solely for the purpose of showcasing, promoting, and marketing the Platform — including in advertisements, social media content, pitch decks, case studies, and platform promotional materials. This licence does not permit Brandior to: (a) use the Deliverables to promote any product, service, or brand other than Brandior itself; (b) sell or sublicense the Deliverables to any third party; or (c) identify the Creator by name in any external publication without the Creator's prior written consent. A Creator may withdraw this showcase licence in respect of specific Deliverables by submitting a written request to support@brandior.africa, and Brandior will cease new use of the identified Deliverables within 30 days of receipt, without prejudice to any use already made.
...
18.2 Suspension and Termination by Brandior. Brandior reserves the right, at its sole discretion and without liability, to take any of the following actions at any time and without prior notice: (a) suspend a User's account temporarily, preventing login and access to Platform features; (b) permanently terminate a User's account and delete associated data in accordance with the Privacy Policy; (c) restrict or disable specific features of a User's account, including but not limited to the ability to create new Collabs, send messages, withdraw wallet funds, or post to the marketplace; (d) block access to the Platform from specific IP addresses, devices, device identifiers, or geographic locations; (e) cancel pending Collab orders and return escrowed funds to the Brand; or (f) any combination of the above. These actions may be taken where Brandior has reasonable grounds to believe that: (i) the User has breached any provision of this Agreement or the Acceptable Use Policy; (ii) the User has engaged in fraudulent, abusive, deceptive, or illegal conduct; (iii) the User's conduct threatens the integrity, safety, security, or reputation of the Platform, its Users, or any third party; (iv) action is required to comply with a legal obligation, court order, or directive from a regulatory authority; or (v) action is required to protect the rights, property, or safety of Brandior, THE OWL COMPANY, other Users, or the public. Brandior is not required to disclose the specific reason for a suspension, restriction, or termination where doing so would prejudice an investigation or a legal obligation of confidentiality. Where practicable and proportionate, Brandior will notify the User of a suspension and provide an opportunity to respond before a permanent termination takes effect. Brandior shall not be liable to any User or third party for any loss or damage arising from any suspension, restriction, blocking, or termination carried out in good faith under this Clause.

18.2A Re-registration After Ban. A User whose account has been permanently terminated by Brandior may not re-register on the Platform, whether under the same or a different name, email address, device, or identity, without Brandior's prior written consent. Re-registration in breach of this Clause is a material breach of this Agreement and may result in immediate re-termination and pursuit of legal remedies.
