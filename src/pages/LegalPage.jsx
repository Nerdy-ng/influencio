...
By registering on Brandior and accepting these Terms, you expressly and irrevocably consent to Brandior's authority to adjudicate disputes arising from collabs on the platform and to issue binding verdicts on the distribution of escrowed funds. (a) Raise a Dispute: Either party may raise a dispute through Brandior's built-in dispute system within 7 days of delivery or expected delivery. Both parties must submit all relevant evidence — screenshots, the agreed brief, delivered files, and communication history. (b) Binding Verdict: Brandior will review all submitted evidence and issue a final, binding verdict on how escrowed funds are distributed. By accepting these Terms, you agree that Brandior's verdict is conclusive and enforceable. You waive any right to contest the distribution of escrowed funds on grounds other than manifest fraud by Brandior. (c) Single Appeal: A verdict may be appealed once within 7 days of notification by submitting new evidence not previously available. The outcome of the appeal is final. (d) Brandior's Role in Disputes: When adjudicating, Brandior acts as a neutral administrator, not as a party, arbitrator, or legal representative. Our verdicts reflect a reasonable assessment of the evidence presented. Brandior is not liable for any loss arising from a verdict reached in good faith. (e) Escalation: Disputes not covered by our escrow system — such as claims against Brandior itself — may be referred to arbitration in Lagos, Nigeria, under the Arbitration and Conciliation Act (as amended). The governing law is the law of the Federal Republic of Nigeria.
